  ...
  return (
    <>
      <div className="  flex items-center justify-center min-h-[calc(100vh+80px)]">
        <div className="grid container py-20 grid-cols-12 items-center ">
          ...
          <div className="  p-4 col-span-12 lg:col-span-5 lg:col-start-8 relative max-lg:flex max-lg:justify-center ">
            <img className="relative z-10" src={hero} alt="Hero" />
            <div className="w-[280px] h-[280px] md:w-[350px] md:h-[350px] absolute top-[6%] blur-[85px] left-0 bg-[#3a96ff]/50"></div>
          </div>
        </div>
